import { PILOT1, PILOT2, PROD1, PROD3, PROD4 } from "../../assets/images";

export default {
  title: <span>Life Changing Productivity</span>,
  images: [PILOT1, PILOT2],
  text: `Time is the ultimate precious commodity. For those who value it most, A1naire offers more than just a ride—we give you back precious hours.
Our Ultra-Luxury vehicles, with Executive Seats, create a space where productivity thrives, allowing you to reclaim up to 200 hours of lost time each year that you are currently losing to driving.`,
