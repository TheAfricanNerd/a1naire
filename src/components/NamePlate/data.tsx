import { DIGITAL_PLATE, DIGITAL_PLATE2 } from "../../assets/images";

export default {
  title: <span>Your Own Digital Plate</span>,
  images: [DIGITAL_PLATE, DIGITAL_PLATE2],
  text: (
    <>
      <p>
        The world’s first customizable digital plate is a brilliant combination
