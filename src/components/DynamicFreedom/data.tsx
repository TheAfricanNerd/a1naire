import { DYNAMIC_FREEDOM } from "../../assets/images";

export default {
  title: <span>Untethered Dynamic Freedom</span>,
  image: DYNAMIC_FREEDOM,
  text: (
    <>
      <p>
        Because you are no longer tethered to a car that is in a parking lot, it
      ...
      <p>
        ...
        point in time, you can hail an Ultra Luxury A1 naire vehicle to meet you
