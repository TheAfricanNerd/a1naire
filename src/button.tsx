...
export const Outline = ({ hancleClick, children, dark }: IButton) => {
  return (
    <div
      className={`my-2 flex gap-2 px-12 py-3 w-full justify-center md:border-slate-900 border-white border-2 ${
        dark ? " bg-black text-white " : "text-black bg-white"
      } rounded-xl cursor-pointer`}
      onClick={hancleClick}
    >
